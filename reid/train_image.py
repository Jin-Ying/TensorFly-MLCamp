...
def image_classification_test(loader, model, test_10crop=True):
    ...
    return accuracy, all_output.numpy(), all_label.numpy()
...
def train(config):
    ...
    for i in range(config["num_iterations"]):
        if i % config["test_interval"] == config["test_interval"] - 1:
            ...
            temp_acc, output, label = image_classification_test(dset_loaders, \
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default='dann_d_a_explore', help="output directory of our model (in ../snapshot directory)")
